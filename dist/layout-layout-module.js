...
module.exports = ":host .logombar{height:44px}:host .navbar{background-color:#fff}:host .navbar .navbar-brand{color:#fff}:host .navbar .nav-item>a{color:#1b1e21}:host .navbar .nav-item>a:hover{color:#FF751A}:host .messages{width:300px}:host .messages .media{border-bottom:1px solid #ddd;padding:5px 10px}:host .messages .media:last-child{border-bottom:none}:host .messages .media-body h5{font-size:13px;font-weight:600}:host .messages .media-body .small{margin:0}:host .messages .media-body .last{font-size:12px;margin:0}\n"
...
module.exports = ".sidebar{border-radius:0;position:fixed;z-index:1000;top:70px;left:235px;width:235px;margin-left:-235px;border:none;border-radius:0;overflow-y:auto;background-color:#fff;background-color:#fff;bottom:0;overflow-x:hidden;padding-bottom:40px;transition:all 0.2s ease-in-out}.sidebar .list-group a.list-group-item{background:#fff;border:0;border-radius:0;color:#1b1e21;text-decoration:none;font-size:14px}.sidebar .list-group a.list-group-item .fa{margin-right:10px}.sidebar .list-group a:hover{background:#FF751A;color:#fff}.sidebar .list-group a.router-link-active{background:#464a4e;color:#fff}.sidebar .list-group .header-fields{padding-top:10px}.sidebar .list-group .header-fields>.list-group-item:first-child{border-top:1px solid rgba(255,255,255,0.2)}.sidebar .sidebar-dropdown *:focus{border-radius:none;border:none}.sidebar .sidebar-dropdown .panel-title{font-size:1rem;height:50px;margin-bottom:0}.sidebar .sidebar-dropdown .panel-title a{color:#999;text-decoration:none;font-weight:400;background:#fff}.sidebar .sidebar-dropdown .panel-title a span{position:relative;display:block;padding:0.75rem 1.5rem;padding-top:1rem}.sidebar .sidebar-dropdown .panel-title a:hover,.sidebar .sidebar-dropdown .panel-title a:focus{color:#fff;outline:none;outline-offset:-2px}.sidebar .sidebar-dropdown .panel-title:hover{background:#f2f2f2}.sidebar .sidebar-dropdown .panel-collapse{border-radious:0;border:none}.sidebar .sidebar-dropdown .panel-collapse .panel-body .list-group-item{border-radius:0;background-color:#fff;border:0 solid transparent}.sidebar .sidebar-dropdown .panel-collapse .panel-body .list-group-item a{color:#999}.sidebar .sidebar-dropdown .panel-collapse .panel-body .list-group-item a:hover{color:#fff}.sidebar .sidebar-dropdown .panel-collapse .panel-body .list-group-item:hover{background:#f2f2f2}.nested-menu .list-group-item{cursor:pointer}.nested-menu .nested{list-style-type:none}.nested-menu ul.submenu{display:none;height:0}.nested-menu .expand ul.submenu{display:block;list-style-type:none;height:auto}.nested-menu .expand ul.submenu li a{color:#1b1e21;padding:10px;display:block;font-size:14px}.nested-menu .expand ul.submenu li a:hover{color:#fff;padding:10px;display:block;text-decoration:none}@media screen and (max-width: 992px){.sidebar{top:54px;left:0px}}@media print{.sidebar{display:none !important}}@media (min-width: 992px){.header-fields{display:none}}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-track{-webkit-box-shadow:inset 0 0 0px #fff;border-radius:3px}::-webkit-scrollbar-thumb{border-radius:3px;-webkit-box-shadow:inset 0 0 3px #fff}\n"
...
module.exports = ".main-container{margin-top:56px;margin-left:235px;padding:15px;-ms-overflow-x:hidden;overflow-x:hidden;overflow-y:scroll;position:relative;overflow:hidden}@media screen and (max-width: 992px){.main-container{margin-left:0px !important}}@media print{.main-container{margin-top:0px !important;margin-left:0px !important}}\n"
